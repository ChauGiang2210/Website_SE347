...
const AddUser = () =>
{
    return (
        <div className='addUser'>
            ...
            <input type="text" className="form-control" placeholder="Nhập địa chỉ" aria-label="." aria-describedby="basic-addon1"/>
            </div>

            <div className="input-group mb-3">
            <span className="input-group-text" id="basic-addon1">Số điện thoại:</span>
            <input type="phone" className="form-control" placeholder="Nhập số điện thoại liên lạc" aria-label="-" aria-describedby="basic-addon1"/>
            </div>
