...
const AddAddress = () =>
{
    return (
        <>
            ...
            <input type="text" className="form-control" id="floatingInput" placeholder="Nhập địa chỉ người nhận"/>
            <label htmlFor="floatingInput">Địa chỉ</label>
            </div>
            <div className="form-floating" style={{width: "80%"}}>
            <input type="phone" className="form-control" id="floatingPassword" placeholder="Nhập số điện thoại người nhận"/>
